...
(custom-set-variables
 ...
 '(package-selected-packages
   '(yasnippet poetry lsp-pyright which-key dap-mode lsp-ivy helm-lsp lsp-treemacs flycheck lsp-ui lsp-mode ibuffer-git nginx-mode rainbow-identifiers rainbow-blocks rainbow-mode jenkinsfile-mode php-mode indent-tools highlight-indentation yaml-mode use-package terraform-mode pyflakes nord-theme neotree markdown-mode magit jinja2-mode ibuffer-vc ibuffer-tramp haskell-mode groovy-mode dockerfile-mode company clojure -mode cargo ansible)))
(custom-set-faces
