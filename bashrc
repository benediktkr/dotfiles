# Default Ubuntu file (9.04?) with only slight modifications. 
#
# Different PS1's:
#   ~$: 
...
alias la='ls -A'
alias l='ls -CF'
alias emacs='/usr/bin/emacsclient -t -a ""'
alias e='/usr/bin/emacsclient -n -c -a ""'
